...
func (c *serverStreamClient) ServerStream(ctx context.Context, in *Data, opts ...grpc.CallOption) (ServerStream_ServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServerStream_ServiceDesc.Streams[0], "/ServerStream.ServerStream/ServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bidirectionClient) Bidirection(ctx context.Context, opts ...grpc.CallOption) (Bidirection_BidirectionClient, error) {
	stream, err := c.cc.NewStream(ctx, &Bidirection_ServiceDesc.Streams[0], "/ServerStream.Bidirection/Bidirection", opts...)
	if err != nil {
		return nil, err
	}
